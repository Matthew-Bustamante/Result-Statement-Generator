...
class StatementTest {
	...
	void testSigStatement() {
		Statement testGenerator = new Statement();
		...
		assertEquals(expected, testGenerator.createSignificantStatement("group 1", "group 2", "7.352", "5.602", "6.078", "0.441", "2.1749", "88", "0.016"));
	}
	/**
	...
	void testNonSigStatement() {
		...
		assertEquals(expected, testGenerator.createNotSignificantStatment("group 1", "group 2", "7.352", "5.602", "6.078", "0.441", "2.1749", "88", "0.016"));
	}
